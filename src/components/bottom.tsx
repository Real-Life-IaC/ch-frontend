...
export function BottomSection() {
    return (
        <div className="mb-16 mt-16 grid text-center lg:max-w-7xl lg:w-full lg:mb-2 lg:grid-cols-3 lg:text-left">
            <a
            ...
            >
                ...
                <div className="lg:text-left mt-4">
                    ...
                    <p className="m-0 max-w-[30ch] text-sm opacity-50">
                        Explore the GitHub public repositories featuring the real-world examples and complete code from the book.
                    </p>
                </div>
            </a>
            ...
            >
                ...
                <div className="lg:text-left mt-4">
                    ...
                    <p className="m-0 max-w-[30ch] text-sm opacity-50">
                        André Sionek is a Lead Software & Data Engineer with expertise in AWS CDK and CI/CD. Passionate about developer experience and automation.</p>
                </div>
            </a>
            ...
            >
                ...
                <div className="lg:text-left mt-4">
                    ...
                    <p className="m-0 max-w-[30ch] text-sm opacity-50">
                        Read the table of contents and the first chapter for free. Get a taste of the content and the author&apos;s style before you buy it.
                    </p>
                </div>
            </a>
